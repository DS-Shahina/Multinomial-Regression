...
mode = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Multinomial Regression/mode.csv")
mode.head(10)

mode.describe()
mode.choice.value_counts() # each category count in the variable "choice"
...
# Test accuracy 
accuracy_score(test.iloc[:,0], test_predict) #0.7032967032967034

train_predict = model.predict(train.iloc[:, 1:]) # Train predictions 
# Train accuracy 
accuracy_score(train.iloc[:,0], train_predict)#0.6961325966850829
